...
let package = Package(
    ...
    dependencies: [
		...
		.package(url: "https://github.com/ryohei-ebisawa/tw-lib-ios-wallet-storage", branch: "main"),
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-siop-openid4vp-swift.git", exact: "0.1.1"),
		.package(url: "https://github.com/ryohei-ebisawa/tw-lib-ios-openid4vci-swift", branch: "main"),
	],
    targets: [
